...
function blog_category_exists( $id = 0 ) {
    return \query\main::blog_category_exists( $id );
}

/* INFO BLOG CATEGORY */

function blog_category_info( $id = 0, $special = array() ) {
    return \query\main::blog_category_info( $id, $special );
}
...
if( !function_exists( 'meta_title' ) ) {
    ...
    function meta_title() {
        ...
        //     return $desc;
        // } elseif($_SERVER['SCRIPT_URL'] == '/stores'){
        ...
        //     return $desc;   
        // }elseif ($_SERVER['REQUEST_URI'] != '/stores' && mb_strpos($_SERVER['REQUEST_URI'],'store') !== false){
