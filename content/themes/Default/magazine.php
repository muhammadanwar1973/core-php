         ...
         <div class="page-dashboard-home__section-posts">
            ...
            <?php
               ...
               if (isset($_GET['category'])) {
                  ...
                  $cond = ($category!='') ? "WHERE category = '$category'" : "";
               }
               if (isset($_GET['limit'])) {
                  $limit = 999999;
               }
            ...
            <div class="post-categories-tabber js-post-categories-tabber" data-component-ready="">
               ...
               All      </a>
               <?php
                  foreach( \query\main::while_blog_categories( array( 'max' => 0, 'show' => 'cats' ), array( 'no_emoticons' => true, 'no_filters' => true ) ) as $cat )
                     {
               ?>
               <a href="?category=<?= $cat->ID ?>" class="post-categories-tabber__link js-post-categories-tabber__link <?= $category==$cat->ID ? 'active' : '' ?>"><?= $cat->name ?></a>
               <?php } ?>
            </div>
            <br>
            <div class="page-list">
               <div class="row">
                  <?php
                     foreach (\query\main::while_blogs(array( 'max' => 6, 'show' => 'blogs', 'category' => $_GET['category'] ?? '' ), array( 'no_emoticons' => true, 'no_filters' => true ) ) as $row) {
                  ?>
                     ...
                     <div id="post-2901" class="posts-list-item-primary page-list__item">
                        ...
                        <div class="posts-list-item-primary__content">
                           <div class="posts-meta posts-list-item-primary__meta">
                              <div class="posts-meta__published">
                                 <i class="posts-meta__published-icon fa fa-clock"></i>&nbsp;<span class="posts-meta__published-text"> <?php echo $row->date; ?> </span>
                              </div>
                              <div class="posts-meta__details">
                                 <span class="posts-meta__details-author"><?= $row->display_name ?></span> in <a href="?category=<?= $row->category; ?>" class="posts-meta__details-category"> <?php echo $row->category_name; ?> </a>
                              </div>
                           </div>
