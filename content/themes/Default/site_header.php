                  ...
                  <div class="layout-menu__body js-layout-menu__body">
                     <div class="layout-menu__body-inner">
                        <ul class="layout-menu__navigation-ul js-layout-menu__navigation-ul">
                           ...
                           <li class="layout-menu__navigation-li js-layout-menu__navigation-li">
                              <a href="/vouchers" class="layout-menu__navigation-link js-layout-menu__navigation-link gtm-navigation <?= checkPageUrl('/vouchers'); ?>"><img data-src="<?= THEME_LOCATION ?>/assets/svgs-coupon/offers.svg" class="layout-menu__navigation-icon lazyload" alt=""><span class="layout-menu__navigation-text">Voucher Codes</span></a>                                
                           </li>
