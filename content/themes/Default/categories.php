                          ...
                          <div class="row">
                            <?php 
                                 ...
                                 if ($ifExist) 
                                 {
                                  ...
                                  <a  href="vouchers?category=<?= $row['id'] ?>" class="shop-categories-list-item-secondary shop-categories-list-secondary__item" title="<?= $row['name'] ?>">
                                      <img class="shop-categories-list-item-secondary__icon lazyloaded" style="filter: none;" alt="" data-src="" src="<?= $row['icon'] ?>"><noscript><img src="<?= $row['icon'] ?>" class="shop-categories-list-item-secondary__icon" alt=""/></noscript>                                <span class="shop-categories-list-item-secondary__title"> <?php echo $row['name']; ?> </span>
