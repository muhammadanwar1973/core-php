...
?>
<style>
    .offers-list-item-tertiary__logo-img{
        padding-top: 10px;
    }
</style>
<div role="main">
     ...
     <div class="container">
         <div class="page-dashboard-home__section">
            ...
            <div class="show-all-link">
               <a href="/stores" class="show-all-link__link">Show all</a>
            </div>
         </div>
     </div>
    <div class="container">
               ...
               <div class="col-12 col-sm-6 col-lg-3">
                  <a href="<?= $link ?>?couponId=<?php echo $row['id']; ?>" class="show-modal  offers-list-item-tertiary offers-list-tertiary__item" title="Besuche design-bestseller">
                     <div class="offers-list-item-tertiary__wrapper">
                        <div class="offers-list-item-tertiary__content-wrapper">
                           <div class="offers-list-item-tertiary__logo">
                              <img class="img-fluid offers-list-item-tertiary__logo-img lazyloaded" alt="<?= $row['title'] ?>"
                              data-src="<?php echo file_exists($row['image']) ? $row['image'] : $row['s_image']; ?>"
                              src="<?php echo file_exists($row['image']) ? $row['image'] : $row['s_image']; ?>"
                              >
                              <noscript><img src="<?php echo $row['image']; ?>" class="img-fluid offers-list-item-tertiary__logo-img" alt="Fun Sport Vision"/></noscript>
                           </div>
                           <div class="offers-list-item-tertiary__details">
      ...
      <div class="container">
         ...
         <div class="offers-list-tertiary">
            <div class="row">
               ...
               $query = "SELECT c.*, s.image AS s_image, IFNULL(c.image, s.image) AS image
                          ...
                          LEFT JOIN stores AS s ON c.store = s.id
                                                    WHERE c.exclusive = 1
                          ORDER BY c.store, c.order_id DESC
                          LIMIT 8";
               $query_run = mysqli_query($db, $query);
               $checkIfExists = mysqli_num_rows($query_run) > 0;
               if ($checkIfExists)
                        ...
                        <div class="offers-list-item-tertiary__content-wrapper">
                           <div class="offers-list-item-tertiary__logo">
                              <img class="img-fluid offers-list-item-tertiary__logo-img lazyloaded" alt="Fun Sport Vision"
                                data-src="<?php echo file_exists($row['image']) ? $row['image'] : $row['s_image']; ?>"
                              src="<?php echo file_exists($row['image']) ? $row['image'] : $row['s_image']; ?>" />
                              <noscript><img src="<?php echo file_exists($row['image']) ? $row['image'] : $row['s_image']; ?>" class="img-fluid offers-list-item-tertiary__logo-img" alt="Fun Sport Vision"/></noscript>
                           </div>
                           <div class="offers-list-item-tertiary__details">
                              <div class="offers-list-item-tertiary__type">
                                 <?php echo $row['title']; ?>
         ...
         <div class="show-all-link">
            <a href="/vouchers" class="show-all-link__link">Show all</a>
         </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-xl-12">
                           <a href="<?= $link ?>?couponId=<?php echo $row['id']; ?>" class="show-modal  offers-list-item-quinary offers-list-quinary__item" title="Besuche Adler">
                              <div class="offers-list-item-quinary__body">
                                 <div class="offers-list-item-quinary__logo-wrapper">
                                    <img class="img-fluid lazyload" alt="<?= $row['title'] ?>" data-src="<?php echo file_exists($row['image']) ? $row['image'] : $row['s_image']; ?>">
                                    <noscript><img src="<?php echo file_exists($row['image']) ? $row['image'] : $row['s_image']; ?>" class="img-fluid" alt="Adler"/></noscript>
                                 </div>
                                 <div class="offers-list-item-quinary__content">
                                    <div class="offers-list-item-quinary__title">
                                       <?php echo $row['description']; ?>
               ...
               <div class="col-12 col-xl-4">
                  ...
                  <div class="offers-list-quinary">
                     <div class="row">
                        <?php
                           require 'includes/site/db.php';
                           $query = "SELECT c.*, s.image AS s_image FROM coupons AS c LEFT JOIN stores AS s ON c.store = s.id WHERE c.expiration>=DATE_SUB(c.expiration,INTERVAL 3 DAY)  ORDER BY c.store, c.order_id ASC  LIMIT 6";
                           $query_run = mysqli_query($db, $query);
                           $checkIfExists = mysqli_num_rows($query_run) > 0;
                           if ($checkIfExists){
                              while($row = mysqli_fetch_array($query_run)){
                        ...
                        <div class="col-12 col-md-6 col-xl-12">
                           <a href="<?= $link ?>?couponId=<?php echo $row['id']; ?>" class="show-modal  offers-list-item-quinary offers-list-quinary__item" title="<?= $row['title'] ?>">
                              <div class="offers-list-item-quinary__body">
                                 <div class="offers-list-item-quinary__logo-wrapper">
                                    <img class="img-fluid lazyload" alt="<?= $row['title'] ?>" data-src="<?php echo file_exists($row['image']) ? $row['image'] : $row['s_image']; ?>">
                                    <noscript><img src="<?php echo file_exists($row['image']) ? $row['image'] : $row['s_image']; ?>" alt="shop4runners"/></noscript>
                                 </div>
                                 <div class="offers-list-item-quinary__content">
                                    <div class="offers-list-item-quinary__title">
                                       <?php echo $row['description']; ?>
         ...
         <div class="page-dashboard-home__section">
            ...
            <div class="offers-list-tertiary">
               <div class="row">
                  ...
                  // require 'includes/site/db.php';
                  $cid = $catrow['id'];
                $query1 = "SELECT c.*, s.image AS s_image, IFNULL(c.image, s.image) AS image
                    FROM coupons AS c
                    LEFT JOIN stores AS s ON c.store = s.id
                  ...
                  <div class="col-12 col-sm-6 col-lg-3">
                     <a href="<?= $link ?>?couponId=<?php echo $row['id']; ?>" class="show-modal  offers-list-item-tertiary offers-list-tertiary__item">
                        <div class="offers-list-item-tertiary__wrapper">
                           <div class="offers-list-item-tertiary__content-wrapper">
                              <div class="offers-list-item-tertiary__logo">
                                 <img class="img-fluid offers-list-item-tertiary__logo-img lazyload" alt="<?= $row['title'] ?>" data-src="<?php echo file_exists($row['image']) ? $row['image'] : $row['s_image']; ?>">
                                 <noscript><img src="<?php echo file_exists($row['image']) ? $row['image'] : $row['s_image']; ?>" class="img-fluid offers-list-item-tertiary__logo-img" alt="<?php echo $row['title']; ?>"/></noscript>
                              </div>
                              <div class="offers-list-item-tertiary__details">
                                 <div class="offers-list-item-tertiary__type">
                                    <?php echo $row['title']; ?>
               ...
               <div class="show-all-link">
                  <a href="/vouchers?category=<?= $catrow['id'] ?>" class="show-all-link__link">Show all</a>
               </div>
            </div>
            <?php      
               }
