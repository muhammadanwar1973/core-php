                       ...
                       if ($checkIfExists)
                        {
                            while($row = mysqli_fetch_array($query_run))
                                {
                   ?>
                    <a href="vouchers?category=<?= $row['id'] ?>" class="layout-footer__link"><?= ucfirst($row['name']) ?></a>
                  <?php } } ?>
               </div>
            </div>
            <div class="layout-footer__column">
   ...
   <div class="page-offers-view__container">
      <div class="page-offers-view__body">
         ...
         <div class="page-offers-view__row page-offers-view__row_first">
            <div class="page-offers-view__block page-offers-view__block_for_code" style="text-align: center;padding-top: 0px;">
               ...
               <div class="page-offers-view__clickout">
                  ...
                  <font style="vertical-align: inherit;">
                  <font style="vertical-align: inherit;">To the Store</font>
                  </font>
                  </a>                        
               </div>
            </div>
         ...
         <div class="page-offers-view__row">
            <div class="page-offers-view__block"  style="padding-top: 0px;">
               <div class="page-offers-view__block-title">
                  <font style="vertical-align: inherit;">
                     <font style="vertical-align: inherit;">
                        Split
