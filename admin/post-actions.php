...
if( isset( $_GET['action'] ) ) {
    ...
    case 'general-settings':
        ...
        //         $files = glob( DIR . '/' . UPLOAD_IMAGES_LOC . '/{store_banner}.{jpg,png,gif,svg}', GLOB_BRACE );
        ...
        //         }
        //   }
            if($_FILES['store_banner']['size'] > 0){
                // print_r ( $_FILES['store_banner']);
            }//die;
            ...
            array(
                ...
                'store_banner' => ( $_FILES['store_banner']['size'] > 0 ? $GLOBALS['siteURL'] . \site\images::upload( @$_FILES['store_banner'] , 'slider_', array( 'path' => DIR . '/', 'current' => '' ) ) : \query\main::get_option( 'store_banner' )  )
            ) ) ) {
