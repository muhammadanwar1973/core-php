...
<form action="?route=post-actions.php&amp;action=general-settings" method="POST" enctype="multipart/form-data">
...
<div class="row"><span>' . t( 'store_banner', "Store Banner" ) . ':</span><div>
